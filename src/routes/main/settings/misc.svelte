...
<Tabs.Content value={SETTINGS_CATEGORY}>
  ...
  <SettingsButton onclick={async () => await openPath(await path.join(await path.appDataDir(), 'tauri-plugin-svelte'))} buttonLabel="Settings" label="Go to Settings Folder" description="Go to settings folder that contains all the setting files for bpsr-logs." />
